...
public class Business extends AppCompatActivity {
    ...
    private String TAG = Business.class.getSimpleName();

    private List<Articles> lstArticles3=new ArrayList<>();
    private ProgressDialog pDialog;
    private ListView lv;

    // URL to get contacts JSON
    private static String API_KEY= "apiKey=d0774924d2b54babb4513a379e12a926";
    private  static String url="https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=d0774924d2b54babb4513a379e12a926";
    ...
    private class GetNews extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Business.this);
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (jsonStr != null) {
                try {
                    ...
                    lstArticles3 = new ArrayList<Articles>();
        ...
        protected void onPostExecute(Void result) {
            ...
            CustomAdapter3 customAdapter3 = new CustomAdapter3(Business.this, lstArticles3);
            lv = (ListView) findViewById(R.id.list);
            lv.setAdapter(customAdapter3);
        }
