...
public class SignIn extends AppCompatActivity
{
    ...
    public void register()
    {
        ...
        if (!validate())
        {
            Toast.makeText(this, "Enter the correct username and password!!If not registered please register to continue.", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public boolean validate()
    {
        ...
        if(password.equals(upass1) && !upass1.isEmpty())
        {
            ...
            Intent intent1 = new Intent(this, ListCategories1.class);
